...
public class OgnlCommaExpressRightPartImpl extends OgnlPsiElement implements OgnlCommaExpressRightPart {

    public OgnlCommaExpressRightPartImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull OgnlVisitor visitor) {
        visitor.visitCommaExpressRightPart(this);
    }

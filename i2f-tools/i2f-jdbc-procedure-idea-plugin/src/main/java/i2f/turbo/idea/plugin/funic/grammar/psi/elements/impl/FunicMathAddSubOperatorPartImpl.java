...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicMathAddSubOperatorPart;
...
public class FunicMathAddSubOperatorPartImpl extends FunicPsiElement implements FunicMathAddSubOperatorPart {

    public FunicMathAddSubOperatorPartImpl(@NotNull ASTNode node) {
        super(node);
    }

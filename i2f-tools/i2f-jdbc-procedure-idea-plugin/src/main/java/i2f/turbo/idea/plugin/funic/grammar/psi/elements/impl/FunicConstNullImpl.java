...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicConstNull;
...
public class FunicConstNullImpl extends FunicPsiElement implements FunicConstNull {

    public FunicConstNullImpl(@NotNull ASTNode node) {
        super(node);
    }

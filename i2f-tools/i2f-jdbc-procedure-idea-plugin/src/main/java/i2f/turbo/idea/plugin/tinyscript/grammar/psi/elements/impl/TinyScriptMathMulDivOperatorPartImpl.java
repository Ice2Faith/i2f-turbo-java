...
public class TinyScriptMathMulDivOperatorPartImpl extends TinyScriptPsiElement implements TinyScriptMathMulDivOperatorPart {

    public TinyScriptMathMulDivOperatorPartImpl(@NotNull ASTNode node) {
        super(node);
    }

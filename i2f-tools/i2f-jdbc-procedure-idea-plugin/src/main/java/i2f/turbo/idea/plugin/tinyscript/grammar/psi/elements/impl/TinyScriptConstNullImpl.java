...
import i2f.turbo.idea.plugin.tinyscript.grammar.psi.elements.TinyScriptConstNull;
...
public class TinyScriptConstNullImpl extends TinyScriptPsiElement implements TinyScriptConstNull {

    public TinyScriptConstNullImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull TinyScriptVisitor visitor) {
        visitor.visitConstNull(this);
    }

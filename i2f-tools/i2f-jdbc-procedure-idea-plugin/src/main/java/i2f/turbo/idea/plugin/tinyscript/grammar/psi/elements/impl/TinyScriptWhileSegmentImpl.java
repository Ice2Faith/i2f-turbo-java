...
import i2f.turbo.idea.plugin.tinyscript.grammar.psi.elements.TinyScriptWhileSegment;
import i2f.turbo.idea.plugin.tinyscript.lang.psi.TinyScriptPsiElement;
import org.jetbrains.annotations.NotNull;

public class TinyScriptWhileSegmentImpl extends TinyScriptPsiElement implements TinyScriptWhileSegment {

    public TinyScriptWhileSegmentImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull TinyScriptVisitor visitor) {
        visitor.visitWhileSegment(this);
    }

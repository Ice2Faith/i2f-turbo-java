...
import i2f.turbo.idea.plugin.ognl.grammar.psi.elements.OgnlScript;
...
public class OgnlScriptImpl extends OgnlPsiElement implements OgnlScript {

    public OgnlScriptImpl(ASTNode node) {
        super(node);
    }

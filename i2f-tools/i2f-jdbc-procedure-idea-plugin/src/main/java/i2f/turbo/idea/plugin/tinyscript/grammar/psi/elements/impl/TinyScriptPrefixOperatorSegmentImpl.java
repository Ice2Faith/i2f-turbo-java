...
import i2f.turbo.idea.plugin.tinyscript.grammar.psi.elements.TinyScriptPrefixOperatorSegment;
...
public class TinyScriptPrefixOperatorSegmentImpl extends TinyScriptPsiElement implements TinyScriptPrefixOperatorSegment {

    public TinyScriptPrefixOperatorSegmentImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull TinyScriptVisitor visitor) {
        visitor.visitPrefixOperatorSegment(this);
    }

...
import i2f.turbo.idea.plugin.ognl.grammar.psi.elements.OgnlSquareExpress;
...
public class OgnlSquareExpressImpl extends OgnlPsiElement implements OgnlSquareExpress {

    public OgnlSquareExpressImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull OgnlVisitor visitor) {
        visitor.visitSquareExpress(this);
    }

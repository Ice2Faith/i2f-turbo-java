...
import i2f.turbo.idea.plugin.ognl.grammar.psi.elements.OgnlReferenceVariableExpress;
...
public class OgnlReferenceVariableExpressImpl extends OgnlPsiElement implements OgnlReferenceVariableExpress {

    public OgnlReferenceVariableExpressImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull OgnlVisitor visitor) {
        visitor.visitReferenceVariableExpress(this);
    }

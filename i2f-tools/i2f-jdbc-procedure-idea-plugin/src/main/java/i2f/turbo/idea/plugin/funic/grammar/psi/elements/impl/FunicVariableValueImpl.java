...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicVariableValue;
...
public class FunicVariableValueImpl extends FunicPsiElement implements FunicVariableValue {

    public FunicVariableValueImpl(@NotNull ASTNode node) {
        super(node);
    }

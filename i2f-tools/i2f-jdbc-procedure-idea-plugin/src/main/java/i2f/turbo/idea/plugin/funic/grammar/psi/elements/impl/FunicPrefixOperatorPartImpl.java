...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicPrefixOperatorPart;
...
public class FunicPrefixOperatorPartImpl extends FunicPsiElement implements FunicPrefixOperatorPart {

    public FunicPrefixOperatorPartImpl(@NotNull ASTNode node) {
        super(node);
    }

...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicCompareOperatorPart;
...
public class FunicCompareOperatorPartImpl extends FunicPsiElement implements FunicCompareOperatorPart {

    public FunicCompareOperatorPartImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitCompareOperatorPart(this);
    }

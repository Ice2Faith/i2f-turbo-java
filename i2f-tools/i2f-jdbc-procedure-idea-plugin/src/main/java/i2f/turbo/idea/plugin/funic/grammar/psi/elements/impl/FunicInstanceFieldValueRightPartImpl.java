...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicInstanceFieldValueRightPart;
...
public class FunicInstanceFieldValueRightPartImpl extends FunicPsiElement implements FunicInstanceFieldValueRightPart {

    public FunicInstanceFieldValueRightPartImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitInstanceFieldValueRightPart(this);
    }

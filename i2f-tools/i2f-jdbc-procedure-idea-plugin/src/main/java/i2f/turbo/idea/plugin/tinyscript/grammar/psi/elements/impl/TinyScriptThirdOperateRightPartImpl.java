...
public class TinyScriptThirdOperateRightPartImpl extends TinyScriptPsiElement implements TinyScriptThirdOperateRightPart {

    public TinyScriptThirdOperateRightPartImpl(@NotNull ASTNode node) {
        super(node);
    }

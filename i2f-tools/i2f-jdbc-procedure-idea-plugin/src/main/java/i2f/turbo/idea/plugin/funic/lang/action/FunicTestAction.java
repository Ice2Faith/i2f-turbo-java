package i2f.turbo.idea.plugin.funic.lang.action;
...
public class FunicTestAction extends AnAction {
    ...
    public static class ConvertDialog extends DialogWrapper {
        ...
        public ConvertDialog(Project project, String initialText) {
            ...
            init(); // 初始化对话框
            setTitle(FunicConsts.LANGUAGE_ID + " Test UI");
        }
        ...
        protected @Nullable JComponent createCenterPanel() {
            ...
            Language language = FunicLanguage.INSTANCE;
            FileType fileType = language.getAssociatedFileType();
            if (fileType == null) {
                fileType = FunicFileType.INSTANCE;
            }

            JComponent editorComponent = null;

            virtualFile = new LightVirtualFile("Virtual." + FunicConsts.FILE_EXTENSION, fileType, initialText == null ? "" : initialText);
        ...
        private void onParseClicked(ActionEvent e) {
            ...
            try {
                FunicParser.RootContext ctx = Funic.parse(sourceText);
        ...
        private void onEvalClicked(ActionEvent e) {
            ...
            try {
                ...
                Object output = Funic.script(sourceText, params);

...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicIncrDecrAfterRightPart;
...
public class FunicIncrDecrAfterRightPartImpl extends FunicPsiElement implements FunicIncrDecrAfterRightPart {

    public FunicIncrDecrAfterRightPartImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitIncrDecrAfterRightPart(this);
    }

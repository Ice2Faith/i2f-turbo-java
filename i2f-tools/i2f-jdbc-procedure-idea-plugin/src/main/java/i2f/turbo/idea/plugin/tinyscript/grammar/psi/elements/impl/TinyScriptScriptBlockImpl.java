...
import i2f.turbo.idea.plugin.tinyscript.grammar.psi.elements.TinyScriptScript;
...
public class TinyScriptScriptBlockImpl extends TinyScriptPsiElement implements TinyScriptScriptBlock {

    public TinyScriptScriptBlockImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    @Override
    @NotNull
    public TinyScriptScript getScript() {
        return findNotNullChildByClass(TinyScriptScript.class);
    }

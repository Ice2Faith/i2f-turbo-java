...
import i2f.turbo.idea.plugin.tinyscript.grammar.psi.elements.TinyScriptNegtiveSegment;
...
public class TinyScriptNegtiveSegmentImpl extends TinyScriptPsiElement implements TinyScriptNegtiveSegment {

    public TinyScriptNegtiveSegmentImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull TinyScriptVisitor visitor) {
        visitor.visitNegtiveSegment(this);
    }

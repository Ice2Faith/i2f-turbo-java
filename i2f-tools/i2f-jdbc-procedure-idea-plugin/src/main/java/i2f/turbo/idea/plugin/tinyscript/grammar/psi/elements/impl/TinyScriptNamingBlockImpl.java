...
public class TinyScriptNamingBlockImpl extends TinyScriptPsiElement implements TinyScriptNamingBlock {

  public TinyScriptNamingBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TinyScriptVisitor visitor) {
    visitor.visitNamingBlock(this);
  }

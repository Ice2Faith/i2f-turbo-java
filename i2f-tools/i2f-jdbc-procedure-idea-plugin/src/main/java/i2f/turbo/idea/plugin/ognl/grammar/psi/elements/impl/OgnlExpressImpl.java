...
public class OgnlExpressImpl extends OgnlPsiElement implements OgnlExpress {

    public OgnlExpressImpl(ASTNode node) {
        super(node);
    }
    ...
    @Override
    @NotNull
    public OgnlExpressSegment getExpressSegment() {
        return findNotNullChildByClass(OgnlExpressSegment.class);
    }

    @Override
    @NotNull
    public List<OgnlOperatorSegment> getOperatorSegmentList() {
        return PsiTreeUtil.getChildrenOfTypeAsList(this, OgnlOperatorSegment.class);
    }

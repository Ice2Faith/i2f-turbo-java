...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicImportExpress;
...
public class FunicImportExpressImpl extends FunicPsiElement implements FunicImportExpress {

    public FunicImportExpressImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitImportExpress(this);
    }

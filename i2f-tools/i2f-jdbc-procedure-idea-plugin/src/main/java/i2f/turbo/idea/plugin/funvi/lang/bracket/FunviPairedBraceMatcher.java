package i2f.turbo.idea.plugin.funvi.lang.bracket;
 ...
 * @desc
 */
public class FunviPairedBraceMatcher implements PairedBraceMatcher {

    private static final BracePair[] PAIRS = new BracePair[]{
            new BracePair(FunviTypes.OP_PAREN_L, FunviTypes.OP_PAREN_R, false)
    };

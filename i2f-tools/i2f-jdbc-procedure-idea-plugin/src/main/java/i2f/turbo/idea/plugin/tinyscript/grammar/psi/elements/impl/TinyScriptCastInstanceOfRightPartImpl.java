...
public class TinyScriptCastInstanceOfRightPartImpl extends TinyScriptPsiElement implements TinyScriptCastInstanceOfRightPart {

    public TinyScriptCastInstanceOfRightPartImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull TinyScriptVisitor visitor) {
        visitor.visitCastInstanceOfRightPart(this);
    }

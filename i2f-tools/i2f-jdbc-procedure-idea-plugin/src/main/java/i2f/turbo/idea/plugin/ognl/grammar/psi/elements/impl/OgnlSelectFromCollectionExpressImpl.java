...
import i2f.turbo.idea.plugin.ognl.grammar.psi.elements.OgnlSelectFromCollectionExpress;
...
public class OgnlSelectFromCollectionExpressImpl extends OgnlPsiElement implements OgnlSelectFromCollectionExpress {

    public OgnlSelectFromCollectionExpressImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull OgnlVisitor visitor) {
        visitor.visitSelectFromCollectionExpress(this);
    }
    ...
    @Override
    @NotNull
    public OgnlSelectFromCollectionModifier getSelectFromCollectionModifier() {
        return findNotNullChildByClass(OgnlSelectFromCollectionModifier.class);
    }

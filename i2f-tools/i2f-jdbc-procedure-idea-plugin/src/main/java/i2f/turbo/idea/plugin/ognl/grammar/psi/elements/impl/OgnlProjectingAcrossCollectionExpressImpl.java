...
import i2f.turbo.idea.plugin.ognl.grammar.psi.elements.OgnlProjectingAcrossCollectionExpress;
...
public class OgnlProjectingAcrossCollectionExpressImpl extends OgnlPsiElement implements OgnlProjectingAcrossCollectionExpress {

    public OgnlProjectingAcrossCollectionExpressImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull OgnlVisitor visitor) {
        visitor.visitProjectingAcrossCollectionExpress(this);
    }

...
public class TinyScriptCompareOperatorPartImpl extends TinyScriptPsiElement implements TinyScriptCompareOperatorPart {

    public TinyScriptCompareOperatorPartImpl(@NotNull ASTNode node) {
        super(node);
    }

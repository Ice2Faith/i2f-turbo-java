...
public class OgnlConstNumericImpl extends OgnlPsiElement implements OgnlConstNumeric {

    public OgnlConstNumericImpl(ASTNode node) {
        super(node);
    }
    ...
    @Override
    @Nullable
    public OgnlConstFloat getConstFloat() {
        return findChildByClass(OgnlConstFloat.class);
    }

...
public class TinyScriptMathAddSubOperatorPartImpl extends TinyScriptPsiElement implements TinyScriptMathAddSubOperatorPart {

    public TinyScriptMathAddSubOperatorPartImpl(@NotNull ASTNode node) {
        super(node);
    }

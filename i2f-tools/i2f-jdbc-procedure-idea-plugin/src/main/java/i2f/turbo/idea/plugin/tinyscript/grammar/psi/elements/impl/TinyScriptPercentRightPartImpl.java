...
public class TinyScriptPercentRightPartImpl extends TinyScriptPsiElement implements TinyScriptPercentRightPart {

    public TinyScriptPercentRightPartImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull TinyScriptVisitor visitor) {
        visitor.visitPercentRightPart(this);
    }

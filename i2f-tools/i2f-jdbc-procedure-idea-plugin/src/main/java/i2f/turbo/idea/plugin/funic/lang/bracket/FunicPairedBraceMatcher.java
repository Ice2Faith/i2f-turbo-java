package i2f.turbo.idea.plugin.funic.lang.bracket;
 ...
 * @desc
 */
public class FunicPairedBraceMatcher implements PairedBraceMatcher {

    private static final BracePair[] PAIRS = new BracePair[]{
            new BracePair(FunicTypes.TERM_BRACKET_SQUARE_L, FunicTypes.TERM_BRACKET_SQUARE_R, false),
            new BracePair(FunicTypes.TERM_PAREN_L, FunicTypes.TERM_PAREN_R, false),
            new BracePair(FunicTypes.TERM_CURLY_L, FunicTypes.TERM_CURLY_L, true)  // true 表示是结构化块（如函数体、代码块）
    };

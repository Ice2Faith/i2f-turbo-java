...
import i2f.turbo.idea.plugin.tinyscript.grammar.psi.elements.TinyScriptNewInstance;
...
public class TinyScriptNewInstanceImpl extends TinyScriptPsiElement implements TinyScriptNewInstance {

    public TinyScriptNewInstanceImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    public TinyScriptInvokeFunction getInvokeFunction() {
        return findNotNullChildByClass(TinyScriptInvokeFunction.class);
    }

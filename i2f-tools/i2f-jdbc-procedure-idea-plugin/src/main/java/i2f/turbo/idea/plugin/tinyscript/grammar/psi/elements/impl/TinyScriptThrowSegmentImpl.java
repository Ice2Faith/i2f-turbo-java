...
import i2f.turbo.idea.plugin.tinyscript.grammar.psi.elements.TinyScriptThrowSegment;
...
public class TinyScriptThrowSegmentImpl extends TinyScriptPsiElement implements TinyScriptThrowSegment {

    public TinyScriptThrowSegmentImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull TinyScriptVisitor visitor) {
        visitor.visitThrowSegment(this);
    }

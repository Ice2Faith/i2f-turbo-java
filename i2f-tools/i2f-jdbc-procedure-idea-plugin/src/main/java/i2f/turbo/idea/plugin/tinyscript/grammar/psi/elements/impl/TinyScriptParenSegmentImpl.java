...
import i2f.turbo.idea.plugin.tinyscript.grammar.psi.elements.TinyScriptParenSegment;
...
public class TinyScriptParenSegmentImpl extends TinyScriptPsiElement implements TinyScriptParenSegment {

    public TinyScriptParenSegmentImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull TinyScriptVisitor visitor) {
        visitor.visitParenSegment(this);
    }

...
public class TinyScriptForSegmentImpl extends TinyScriptPsiElement implements TinyScriptForSegment {

  public TinyScriptForSegmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TinyScriptVisitor visitor) {
    visitor.visitForSegment(this);
  }

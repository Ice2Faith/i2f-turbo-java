...
import i2f.turbo.idea.plugin.funvi.grammar.psi.elements.FunviSegment;
...
public class FunviBlockBodyImpl extends FunviPsiElement implements FunviBlockBody {

    public FunviBlockBodyImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    @Override
    @NotNull
    public List<FunviSegment> getSegmentList() {
        return PsiTreeUtil.getChildrenOfTypeAsList(this, FunviSegment.class);
    }

...
public class FunicFullNameImpl extends FunicPsiElement implements FunicFullName {

    public FunicFullNameImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitFullName(this);
    }

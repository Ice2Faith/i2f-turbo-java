...
import i2f.turbo.idea.plugin.ognl.grammar.parser.OgnlParser;
...
public class OgnlParserDefinition implements ParserDefinition {
    public static final IFileElementType FILE = new IFileElementType(OgnlLanguage.INSTANCE);
    ...
    public @NotNull PsiFile createFile(@NotNull FileViewProvider viewProvider) {
        return new OgnlFile(viewProvider);
    }
}

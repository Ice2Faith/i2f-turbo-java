...
public class OgnlConstExpressImpl extends OgnlPsiElement implements OgnlConstExpress {

    public OgnlConstExpressImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull OgnlVisitor visitor) {
        visitor.visitConstExpress(this);
    }
    ...
    @Override
    @Nullable
    public OgnlConstBoolean getConstBoolean() {
        return findChildByClass(OgnlConstBoolean.class);
    }

    @Override
    @Nullable
    public OgnlConstNull getConstNull() {
        return findChildByClass(OgnlConstNull.class);
    }

    @Override
    @Nullable
    public OgnlConstNumeric getConstNumeric() {
        return findChildByClass(OgnlConstNumeric.class);
    }

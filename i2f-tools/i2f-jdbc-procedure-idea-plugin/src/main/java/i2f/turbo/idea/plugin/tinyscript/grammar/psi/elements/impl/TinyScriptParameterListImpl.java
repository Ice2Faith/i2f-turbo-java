...
public class TinyScriptParameterListImpl extends TinyScriptPsiElement implements TinyScriptParameterList {

    public TinyScriptParameterListImpl(@NotNull ASTNode node) {
        super(node);
    }

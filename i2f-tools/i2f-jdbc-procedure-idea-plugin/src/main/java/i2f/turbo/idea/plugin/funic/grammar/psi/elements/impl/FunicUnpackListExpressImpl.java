...
public class FunicUnpackListExpressImpl extends FunicPsiElement implements FunicUnpackListExpress {

    public FunicUnpackListExpressImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitUnpackListExpress(this);
    }

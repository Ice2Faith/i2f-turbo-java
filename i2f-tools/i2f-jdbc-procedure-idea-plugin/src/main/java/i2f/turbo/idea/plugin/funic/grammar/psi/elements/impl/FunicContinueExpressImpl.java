...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicContinueExpress;
...
public class FunicContinueExpressImpl extends FunicPsiElement implements FunicContinueExpress {

    public FunicContinueExpressImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitContinueExpress(this);
    }

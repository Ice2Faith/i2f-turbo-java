...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicDebuggerExpress;
...
public class FunicDebuggerExpressImpl extends FunicPsiElement implements FunicDebuggerExpress {

    public FunicDebuggerExpressImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitDebuggerExpress(this);
    }

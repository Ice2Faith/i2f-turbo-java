...
public class FunviBlockImpl extends FunviPsiElement implements FunviBlock {
    ...
    public FunviBlockImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    @Override
    @Nullable
    public FunviCommonBlock getCommonBlock() {
        return findChildByClass(FunviCommonBlock.class);
    }

    @Override
    @Nullable
    public FunviIfBlock getIfBlock() {
        return findChildByClass(FunviIfBlock.class);
    }

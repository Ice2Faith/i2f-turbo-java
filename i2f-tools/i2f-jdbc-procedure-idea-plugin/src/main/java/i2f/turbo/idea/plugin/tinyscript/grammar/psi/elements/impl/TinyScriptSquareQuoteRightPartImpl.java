...
public class TinyScriptSquareQuoteRightPartImpl extends TinyScriptPsiElement implements TinyScriptSquareQuoteRightPart {

    public TinyScriptSquareQuoteRightPartImpl(@NotNull ASTNode node) {
        super(node);
    }

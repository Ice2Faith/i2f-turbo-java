...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicFactorRightPart;
...
public class FunicFactorRightPartImpl extends FunicPsiElement implements FunicFactorRightPart {

    public FunicFactorRightPartImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitFactorRightPart(this);
    }

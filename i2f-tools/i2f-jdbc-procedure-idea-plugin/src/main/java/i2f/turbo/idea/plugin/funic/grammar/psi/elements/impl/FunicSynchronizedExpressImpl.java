...
import i2f.turbo.idea.plugin.funic.grammar.psi.elements.FunicSynchronizedExpress;
...
public class FunicSynchronizedExpressImpl extends FunicPsiElement implements FunicSynchronizedExpress {

    public FunicSynchronizedExpressImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitSynchronizedExpress(this);
    }

package i2f.turbo.idea.plugin.ognl.lang.bracket;
 ...
 * @desc
 */
public class OgnlPairedBraceMatcher implements PairedBraceMatcher {

    private static final BracePair[] PAIRS = new BracePair[]{
            new BracePair(OgnlTypes.TERM_BRACKET_SQUARE_L, OgnlTypes.TERM_BRACKET_SQUARE_R, false),
            new BracePair(OgnlTypes.TERM_PAREN_L, OgnlTypes.TERM_PAREN_R, false),
            new BracePair(OgnlTypes.TERM_CURLY_L, OgnlTypes.TERM_CURLY_L, true)  // true 表示是结构化块（如函数体、代码块）
    };

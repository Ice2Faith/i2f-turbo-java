...
public class TinyScriptLogicalLinkOperatorPartImpl extends TinyScriptPsiElement implements TinyScriptLogicalLinkOperatorPart {

    public TinyScriptLogicalLinkOperatorPartImpl(@NotNull ASTNode node) {
        super(node);
    }

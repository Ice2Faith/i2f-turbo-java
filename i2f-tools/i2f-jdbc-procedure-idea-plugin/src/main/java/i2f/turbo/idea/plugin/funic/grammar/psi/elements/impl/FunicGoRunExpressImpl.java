...
public class FunicGoRunExpressImpl extends FunicPsiElement implements FunicGoRunExpress {

    public FunicGoRunExpressImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull FunicVisitor visitor) {
        visitor.visitGoRunExpress(this);
    }

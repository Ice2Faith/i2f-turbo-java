...
public class OracleGrammarParser extends Parser {
    ...
    public static class ReturnSegmentContext extends ParserRuleContext {
        public TerminalNode KEY_RETURN() {
            return getToken(OracleGrammarParser.KEY_RETURN, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleGrammarVisitor)
                return ((OracleGrammarVisitor<? extends T>) visitor).visitReturnSegment(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ConditionCompositeSegmentContext extends ParserRuleContext {
        ...
        public TerminalNode KEY_AND() {
            return getToken(OracleGrammarParser.KEY_AND, 0);
        }
    ...
    public static class IfElseSegmentContext extends ParserRuleContext {
        ...
        public List<TerminalNode> KEY_ELSIF() {
            return getTokens(OracleGrammarParser.KEY_ELSIF);
        }

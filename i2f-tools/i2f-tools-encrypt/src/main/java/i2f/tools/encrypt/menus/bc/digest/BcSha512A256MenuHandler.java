...
public class BcSha512A256MenuHandler implements IMenuHandler {

    @Override
    public String name() {
        return "bc-sha512-256";
    }
    ...
    public void execute(String[] args) throws Exception {
        ...
        for (String item : args) {
            String encode = CodecUtil.toHexString(BcMessageDigester.SHA512_256.digest(item.getBytes("UTF-8")));

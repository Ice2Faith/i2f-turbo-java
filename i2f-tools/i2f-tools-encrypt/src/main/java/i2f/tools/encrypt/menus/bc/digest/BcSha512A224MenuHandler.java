...
public class BcSha512A224MenuHandler implements IMenuHandler {

    @Override
    public String name() {
        return "bc-sha512-224";
    }
    ...
    public void execute(String[] args) throws Exception {
        ...
        for (String item : args) {
            String encode = CodecUtil.toHexString(BcMessageDigester.SHA512_224.digest(item.getBytes("UTF-8")));

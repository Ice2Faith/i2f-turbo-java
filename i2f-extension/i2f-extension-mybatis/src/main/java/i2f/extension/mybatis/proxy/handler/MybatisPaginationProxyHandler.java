...
import i2f.extension.mybatis.interceptor.MybatisPagination;
...
/**
 * @author Ice2Faith
 * @date 2025/7/23 15:33
 */
public class MybatisPaginationProxyHandler implements IProxyInvocationHandler {
    ...
    public Object invoke(Object ivkObj, IInvokable invokable, Object... args) throws Throwable {
        ...
        Executor executor = (Executor) ivkObj;

 ...
 */
public class TestDefaultProcedureExecutor {
...
//        testProcedure();
    ...
    public static void testProcedure() throws Exception {
        File file = new File("./i2f-extension/i2f-extension-xproc4j/src/test/java/i2f/jdbc/procedure/test/test-basic.xml");
...
//        BasicJdbcProcedureExecutor executor = new BasicJdbcProcedureExecutor();
        ...
        TestDefaultSimpleJavaCaller caller = new TestDefaultSimpleJavaCaller();

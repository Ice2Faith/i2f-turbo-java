 ...
 * @desc
 */
public class Langchain4j8JsonSchemaAnnotationResolver extends JsonSchemaAnnotationResolver {
    public static final Langchain4j8JsonSchemaAnnotationResolver INSTANCE = new Langchain4j8JsonSchemaAnnotationResolver();

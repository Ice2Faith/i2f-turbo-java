...
public interface TinyScriptVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by {@link TinyScriptParser#prefixOperator}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitPrefixOperator(TinyScriptParser.PrefixOperatorContext ctx);

    /**
     * Visit a parse tree produced by {@link TinyScriptParser#pipelineFunctionSegment}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitPipelineFunctionSegment(TinyScriptParser.PipelineFunctionSegmentContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link TinyScriptParser#doWhileSegment}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitDoWhileSegment(TinyScriptParser.DoWhileSegmentContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link TinyScriptParser#staticEnumValue}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitStaticEnumValue(TinyScriptParser.StaticEnumValueContext ctx);

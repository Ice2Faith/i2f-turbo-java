...
public class TinyScriptBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements TinyScriptVisitor<T> {
     ...
     */
    @Override
    public T visitPrefixOperator(TinyScriptParser.PrefixOperatorContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitJsonArrayValue(TinyScriptParser.JsonArrayValueContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitJsonItemList(TinyScriptParser.JsonItemListContext ctx) {
        return visitChildren(ctx);
    }
}
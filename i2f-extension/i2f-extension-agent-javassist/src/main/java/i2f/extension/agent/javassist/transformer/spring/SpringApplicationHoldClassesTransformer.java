 ...
 * @desc
 */
public class SpringApplicationHoldClassesTransformer implements ClassFileTransformer, InstrumentTransformerFeature {
    ...
    public void onAdded(Instrumentation inst) {
        AgentUtil.retransformLoadedClasses(inst, (clazz) -> {
            ...
            for (String[] arr : INJECT_APPLICATION_CLASS_FIELD_ARRAY) {

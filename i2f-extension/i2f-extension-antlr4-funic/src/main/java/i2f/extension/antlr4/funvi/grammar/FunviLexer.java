...
public class FunviLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"REF_VALUE", "BLOCK_END", "BLOCK_ELSE", "BLOCK_IF", "BLOCK_HEAD", "IDENTIFIER", 
			"WHITESPACE", "PAREN_L", "PAREN_R", "COMMA", "SHARP", "DOLLAR", "EXCLAIM", 
			"COLON", "TEXT"
		};
	}
	...
	public FunviLexer(CharStream input) {
		super(input);

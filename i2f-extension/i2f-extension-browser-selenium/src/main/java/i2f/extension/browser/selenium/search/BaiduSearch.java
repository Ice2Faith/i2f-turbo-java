...
public class BaiduSearch {
    ...
    public static SearchContext baiduSearch(String question, String driverPath) {
        return baiduSearch(question, 5, driverPath);
    }

    public static SearchContext baiduSearch(String question, int maxArticleCount, String driverPath) {
...
//                        System.out.println("www-href:\n" + href);
                        WebElement aElem = item.findElement(By.cssSelector("a.sc-link"));
                        if (aElem != null) {

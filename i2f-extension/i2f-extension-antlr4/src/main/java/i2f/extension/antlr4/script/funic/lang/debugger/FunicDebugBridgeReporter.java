package i2f.extension.antlr4.script.funic.lang.debugger;
 ...
 * @desc
 */
public final class FunicDebugBridgeReporter {
    ...
    public static void proxy(String fileName, int lineNumber, Map<String, Object> variableMap) {
        ...
        FunicDebugBridgeReporter instance = new FunicDebugBridgeReporter();

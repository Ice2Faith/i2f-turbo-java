...
public interface FunicListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link FunicParser#logicalLinkHighOperatorPart}.
     *
     * @param ctx the parse tree
     */
    void enterLogicalLinkHighOperatorPart(FunicParser.LogicalLinkHighOperatorPartContext ctx);

    /**
     * Exit a parse tree produced by {@link FunicParser#logicalLinkHighOperatorPart}.
     *
     * @param ctx the parse tree
     */
    void exitLogicalLinkHighOperatorPart(FunicParser.LogicalLinkHighOperatorPartContext ctx);

    /**
     * Enter a parse tree produced by {@link FunicParser#logicalLinkLowOperatorPart}.
     *
     * @param ctx the parse tree
     */
    void enterLogicalLinkLowOperatorPart(FunicParser.LogicalLinkLowOperatorPartContext ctx);

    /**
     * Exit a parse tree produced by {@link FunicParser#logicalLinkLowOperatorPart}.
     *
     * @param ctx the parse tree
     */
    void exitLogicalLinkLowOperatorPart(FunicParser.LogicalLinkLowOperatorPartContext ctx);

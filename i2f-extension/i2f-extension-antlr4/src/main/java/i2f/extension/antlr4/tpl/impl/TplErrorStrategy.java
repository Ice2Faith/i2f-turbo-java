...
import i2f.extension.antlr4.tpl.impl.exception.impl.TplParseException;
 ...
 * @desc
 */
public class TplErrorStrategy extends DefaultErrorStrategy {
    @Override
    public void reportError(Parser parser, RecognitionException e) {
        ...
        TplParseException ex = new TplParseException(errorMsg, e);
        ex.setLine(line);

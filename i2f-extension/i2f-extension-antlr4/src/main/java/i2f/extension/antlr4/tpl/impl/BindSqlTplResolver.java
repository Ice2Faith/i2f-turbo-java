...
@Data
@NoArgsConstructor
public class BindSqlTplResolver extends DefaultTplResolver {
    ...
    protected void initBlockHandlers() {
        ...
        blockHandlers.put("where", (parameterList, bodyCtx, context, visitor) -> {
            if (bodyCtx == null) {
                throw new TplEvaluateException("where block require body!");
            }
        ...
        blockHandlers.put("set", (parameterList, bodyCtx, context, visitor) -> {
            if (bodyCtx == null) {
                throw new TplEvaluateException("set block require body!");
            }
            Object ret = visitor.visitBlockBody(bodyCtx);
            if (ret != null) {
                String text = String.valueOf(ret);

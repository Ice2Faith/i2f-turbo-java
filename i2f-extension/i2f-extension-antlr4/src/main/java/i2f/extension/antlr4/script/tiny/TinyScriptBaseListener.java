...
public class TinyScriptBaseListener implements TinyScriptListener {
     ...
     */
    @Override
    public void enterScript(TinyScriptParser.ScriptContext ctx) {
    }
     ...
     */
    @Override
    public void exitScript(TinyScriptParser.ScriptContext ctx) {
    }
     ...
     */
    @Override
    public void enterPrefixOperator(TinyScriptParser.PrefixOperatorContext ctx) {
    }
     ...
     */
    @Override
    public void exitPrefixOperator(TinyScriptParser.PrefixOperatorContext ctx) {
    }

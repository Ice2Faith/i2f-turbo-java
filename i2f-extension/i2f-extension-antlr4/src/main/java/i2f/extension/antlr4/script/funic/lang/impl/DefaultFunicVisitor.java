...
public class DefaultFunicVisitor implements FunicVisitor<FunicValue> {
    ...
    public FunicValue processExtraExpress(FunicParser.ExtractExpressContext extraCtx,
        ...
        if (!"=".equalsIgnoreCase(operator)) {
            throw new FunicEvaluateException(getTreeLocationText("location ", extraCtx, " ") + "extra express only support '=' operator, but found '" + operator + "'!");
        }
        ...
        for (Object item : extraList) {
            ...
            if (!(leftExtraValue instanceof ParentFunicValue)) {
                throw new FunicEvaluateException(getTreeLocationText("location ", extraCtx, " ") + "extra express key cannot be assigned!");
            }
                    ...
                    if (obj instanceof FunicMethod) {
                        ...
                        if (funicMethod.getParameterCount() == 0) {
                            ...
                            try {
                                ...
                                throw new FunicThrowException(getTreeLocationText("location ", ctx, " ") + e.getMessage(), e);
                            }
                        } else {
                            throw new FunicThrowException(getTreeLocationText("location ", ctx, " ") + "go task cannot support run function with args!");
                        }
    ...
    public FunicValue visitTryCatchFinallyExpress(FunicParser.TryCatchFinallyExpressContext ctx) {
        try {
            ...
            try {
                ...
                if (rawEx instanceof FunicControlException) {
                    throw (FunicControlException) rawEx;
                }
                boolean resolved = false;
                // unwrap funic exception
                Throwable e = rawEx;
                if (e instanceof FunicException) {
                    Throwable ex = e;
                    while (ex instanceof FunicException) {
                        ex = ex.getCause();
                        if (ex != null) {
                            e = ex;
                        }
    ...
    public FunicValue visitThrowExpress(FunicParser.ThrowExpressContext ctx) {
        try {
            ...
            if (value instanceof RuntimeException) {
                ...
                throw new FunicThrowException(getTreeLocationText("location ", ctx, " ") + ex.getMessage(), ex);
            }
            throw new FunicThrowDataException(value, getTreeLocationText("location ", ctx, " ") + "grammar defined!");
        } catch (Throwable e) {
            if (e instanceof FunicException) {
                throw (FunicException) e;
            }
    ...
    public FunicValue visitReturnExpress(FunicParser.ReturnExpressContext ctx) {
        try {
            ...
            if (count == 2) {
                FunicParser.ExpressContext nextCtx = (FunicParser.ExpressContext) ctx.getChild(1);
                FunicValue value = visitExpress(nextCtx);
                throw new FunicReturnException(getTreeLocationText("location ", ctx, " ") + "grammar defined!", value.get());
            }
            throw new FunicReturnException(getTreeLocationText("location ", ctx, " ") + "grammar defined!");
        } catch (Throwable e) {
            if (e instanceof FunicException) {
                throw (FunicException) e;
            }
    ...
    public FunicValue visitContinueExpress(FunicParser.ContinueExpressContext ctx) {
        try {
            debugNode(ctx);
            throw new FunicContinueException(getTreeLocationText("location ", ctx, " ") + "grammar defined!");
        } catch (Throwable e) {
            if (e instanceof FunicException) {
                throw (FunicException) e;
            }
    ...
    public FunicValue visitBreakExpress(FunicParser.BreakExpressContext ctx) {
        try {
            debugNode(ctx);
            throw new FunicBreakException(getTreeLocationText("location ", ctx, " ") + "grammar defined!");
        } catch (Throwable e) {
            if (e instanceof FunicException) {
                throw (FunicException) e;
            }
    ...
    public FunicValue visitNewArrayExpress(FunicParser.NewArrayExpressContext ctx) {
        try {
            ...
            if (candidateCtx instanceof FunicParser.ConstNumberContext) {
                ...
                if (initList == null) {
                    throw new FunicThrowException(getTreeLocationText("location ", ctx, " ") + "new array with list detect array length, must has init list!");
                }
    ...
    public FunicValue visit(ParseTree tree) {
        try {
            ...
            throw new FunicEvaluateException(getTreeLocationText("location ", tree, " ") + "cause by: " + e.getMessage(), e);
        }
    }
    ...
    @Override
    public FunicValue visitTerminal(TerminalNode ctx) {
        try {
            debugNode(ctx);
            Token symbol = ctx.getSymbol();
            int symbolType = symbol.getType();
            String symbolText = symbol.getText();
            String terminalText = ctx.getText();

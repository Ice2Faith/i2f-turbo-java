...
public class FunicBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements FunicVisitor<T> {
     ...
     */
    @Override
    public T visitLogicalLinkHighOperatorPart(FunicParser.LogicalLinkHighOperatorPartContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitLogicalLinkLowOperatorPart(FunicParser.LogicalLinkLowOperatorPartContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitFunctionName(FunicParser.FunctionNameContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitConstNull(FunicParser.ConstNullContext ctx) {
        return visitChildren(ctx);
    }
}
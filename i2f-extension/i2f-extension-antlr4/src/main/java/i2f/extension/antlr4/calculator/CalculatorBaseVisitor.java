...
public class CalculatorBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CalculatorVisitor<T> {
     ...
     */
    @Override
    public T visitEval(CalculatorParser.EvalContext ctx) {
     ...
     */
    @Override
    public T visitExpr(CalculatorParser.ExprContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitPrefixOperator(CalculatorParser.PrefixOperatorContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitSuffixOperator(CalculatorParser.SuffixOperatorContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitOperatorV5(CalculatorParser.OperatorV5Context ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitOperatorV4(CalculatorParser.OperatorV4Context ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitOperatorV3(CalculatorParser.OperatorV3Context ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitOperatorV2(CalculatorParser.OperatorV2Context ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitOperatorV1(CalculatorParser.OperatorV1Context ctx) {
        return visitChildren(ctx);
    }

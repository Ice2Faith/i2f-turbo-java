...
public interface FunicVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by {@link FunicParser#logicalLinkHighOperatorPart}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitLogicalLinkHighOperatorPart(FunicParser.LogicalLinkHighOperatorPartContext ctx);

    /**
     * Visit a parse tree produced by {@link FunicParser#logicalLinkLowOperatorPart}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitLogicalLinkLowOperatorPart(FunicParser.LogicalLinkLowOperatorPartContext ctx);

...
public class FunicParser extends Parser {
	...
	public static final int
		...
		KW_GTE=95, KW_LTE=96, KW_GT=97, KW_LT=98, KW_NEQ=99, KW_NE=100, KW_EQ=101, 
		KW_IN=102, KW_INSTANCEOF=103, KW_IS=104, KW_AND=105, KW_OR=106, KW_GO=107, 
		KW_SYNCHRONIZED=108, KW_IMPORT=109, KW_DEBUGGER=110, IDENTIFIER=111, WS=112;
	public static final int
		...
		RULE_staticFunctionCall = 54, RULE_functionName = 55, RULE_functionArguments = 56, 
		RULE_functionArgument = 57, RULE_listValueExpress = 58, RULE_unpackListExpress = 59, 
		RULE_fullName = 60, RULE_typeClass = 61, RULE_typeReference = 62, RULE_typeMember = 63, 
		RULE_valueSegment = 64, RULE_refValue = 65, RULE_variableValue = 66, RULE_constValue = 67, 
		RULE_constCharSequence = 68, RULE_constString = 69, RULE_constRenderString = 70, 
		RULE_constMultiString = 71, RULE_constNumeric = 72, RULE_constNumber = 73, 
		RULE_constFloat = 74, RULE_constBoolean = 75, RULE_constNull = 76;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"functionName", "functionArguments", "functionArgument", "listValueExpress", 
			"unpackListExpress", "fullName", "typeClass", "typeReference", "typeMember", 
			"valueSegment", "refValue", "variableValue", "constValue", "constCharSequence", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'teq'", "'tneq'", "'gte'", "'lte'", "'gt'", "'lt'", "'neq'", "'ne'", 
			"'eq'", "'in'", "'instanceof'", "'is'", "'and'", "'or'", "'go'", "'synchronized'", 
			"'import'", "'debugger'"
		};
	}
	...
	@Override
	public String getGrammarFileName() { return "Funic.g4"; }
	...
	public static class RootContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(FunicParser.EOF, 0); }
	...
	public static class ExpressContext extends ParserRuleContext {
		...
		public TerminalNode KW_DEF() { return getToken(FunicParser.KW_DEF, 0); }
	...
	public static class DebuggerExpressContext extends ParserRuleContext {
		public TerminalNode KW_DEBUGGER() { return getToken(FunicParser.KW_DEBUGGER, 0); }
		...
		@Override public int getRuleIndex() { return RULE_debuggerExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitDebuggerExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ExtractExpressContext extractExpress() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -252165230690271180L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 272679303068671L) != 0)) {
				{
				setState(275);
				extractPairs();
				}
	...
	public static class LogicalLinkOperatorPartContext extends ParserRuleContext {
		public TerminalNode KW_AND() { return getToken(FunicParser.KW_AND, 0); }
		public TerminalNode KW_OR() { return getToken(FunicParser.KW_OR, 0); }
		public LogicalLinkOperatorPartContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_logicalLinkOperatorPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitLogicalLinkOperatorPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CompareOperatorPartContext extends ParserRuleContext {
		public TerminalNode KW_TEQ() { return getToken(FunicParser.KW_TEQ, 0); }
		public TerminalNode KW_TNEQ() { return getToken(FunicParser.KW_TNEQ, 0); }
		public TerminalNode KW_GT() { return getToken(FunicParser.KW_GT, 0); }
		public TerminalNode KW_GTE() { return getToken(FunicParser.KW_GTE, 0); }
		public TerminalNode KW_LT() { return getToken(FunicParser.KW_LT, 0); }
		public TerminalNode KW_LTE() { return getToken(FunicParser.KW_LTE, 0); }
		public TerminalNode KW_EQ() { return getToken(FunicParser.KW_EQ, 0); }
		public TerminalNode KW_NEQ() { return getToken(FunicParser.KW_NEQ, 0); }
		public TerminalNode KW_NE() { return getToken(FunicParser.KW_NE, 0); }
		public TerminalNode KW_IN() { return getToken(FunicParser.KW_IN, 0); }
		public TerminalNode KW_INSTANCEOF() { return getToken(FunicParser.KW_INSTANCEOF, 0); }
		public TerminalNode KW_IS() { return getToken(FunicParser.KW_IS, 0); }
		public TerminalNode KW_NOT() { return getToken(FunicParser.KW_NOT, 0); }
		public CompareOperatorPartContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_compareOperatorPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitCompareOperatorPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BitOperatorPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_bitOperatorPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitBitOperatorPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MathAddSubOperatorPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_mathAddSubOperatorPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitMathAddSubOperatorPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MathMulDivOperatorPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_mathMulDivOperatorPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitMathMulDivOperatorPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IncrDecrPrefixOperatorPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_incrDecrPrefixOperatorPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitIncrDecrPrefixOperatorPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PrefixOperatorPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_prefixOperatorPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitPrefixOperatorPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PipelineFunctionExpressContext extends ParserRuleContext {
		...
		public TerminalNode IDENTIFIER() { return getToken(FunicParser.IDENTIFIER, 0); }
		public PipelineFunctionExpressContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_pipelineFunctionExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitPipelineFunctionExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SynchronizedExpressContext extends ParserRuleContext {
		public TerminalNode KW_SYNCHRONIZED() { return getToken(FunicParser.KW_SYNCHRONIZED, 0); }
		public ExpressContext express() {
			return getRuleContext(ExpressContext.class,0);
		}
		public ScriptBlockContext scriptBlock() {
		...
		@Override public int getRuleIndex() { return RULE_synchronizedExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitSynchronizedExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LambdaExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_lambdaExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class ImportExpressContext extends ParserRuleContext {
		public TerminalNode KW_IMPORT() { return getToken(FunicParser.KW_IMPORT, 0); }
		public FullNameContext fullName() {
			return getRuleContext(FullNameContext.class,0);
		}
		...
		@Override public int getRuleIndex() { return RULE_importExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class GoRunExpressContext extends ParserRuleContext {
		public TerminalNode KW_GO() { return getToken(FunicParser.KW_GO, 0); }
		public LambdaExpressContext lambdaExpress() {
			return getRuleContext(LambdaExpressContext.class,0);
		}
		public ScriptBlockContext scriptBlock() {
		...
		@Override public int getRuleIndex() { return RULE_goRunExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class AwaitExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_awaitExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class FunctionDeclareExpressContext extends ParserRuleContext {
		...
		public TerminalNode KW_FUNC() { return getToken(FunicParser.KW_FUNC, 0); }
		public TerminalNode KW_DEF() { return getToken(FunicParser.KW_DEF, 0); }
		...
		@Override public int getRuleIndex() { return RULE_functionDeclareExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitFunctionDeclareExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionDeclareReturnContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_functionDeclareReturn; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitFunctionDeclareReturn(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionDeclareParametersContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_functionDeclareParameters; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitFunctionDeclareParameters(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionParameterContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitFunctionParameter(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TryCatchFinallyExpressContext extends ParserRuleContext {
		public TerminalNode KW_TRY() { return getToken(FunicParser.KW_TRY, 0); }
		...
		public TerminalNode KW_FINALLY() { return getToken(FunicParser.KW_FINALLY, 0); }
		public TryCatchFinallyExpressContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_tryCatchFinallyExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitTryCatchFinallyExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CatchBlockContext extends ParserRuleContext {
		public TerminalNode KW_CATCH() { return getToken(FunicParser.KW_CATCH, 0); }
		public TerminalNode IDENTIFIER() { return getToken(FunicParser.IDENTIFIER, 0); }
		public ScriptBlockContext scriptBlock() {
			return getRuleContext(ScriptBlockContext.class,0);
		}
	...
	public static class ThrowExpressContext extends ParserRuleContext {
		public TerminalNode KW_THROW() { return getToken(FunicParser.KW_THROW, 0); }
		public ExpressContext express() {
			return getRuleContext(ExpressContext.class,0);
		}
		...
		@Override public int getRuleIndex() { return RULE_throwExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class ReturnExpressContext extends ParserRuleContext {
		public TerminalNode KW_RETURN() { return getToken(FunicParser.KW_RETURN, 0); }
		public ExpressContext express() {
			return getRuleContext(ExpressContext.class,0);
		}
		...
		@Override public int getRuleIndex() { return RULE_returnExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class ContinueExpressContext extends ParserRuleContext {
		public TerminalNode KW_CONTINUE() { return getToken(FunicParser.KW_CONTINUE, 0); }
		public ContinueExpressContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_continueExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitContinueExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BreakExpressContext extends ParserRuleContext {
		public TerminalNode KW_BREAK() { return getToken(FunicParser.KW_BREAK, 0); }
		public BreakExpressContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_breakExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class ForRangeExpressContext extends ParserRuleContext {
		public TerminalNode KW_FOR() { return getToken(FunicParser.KW_FOR, 0); }
		public TerminalNode IDENTIFIER() { return getToken(FunicParser.IDENTIFIER, 0); }
		public List<ExpressContext> express() {
			return getRuleContexts(ExpressContext.class);
		}
		...
		@Override public int getRuleIndex() { return RULE_forRangeExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitForRangeExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ForLoopExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_forLoopExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class ForeachExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_foreachExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class DoWhileExpressContext extends ParserRuleContext {
		public TerminalNode KW_DO() { return getToken(FunicParser.KW_DO, 0); }
		public ScriptBlockContext scriptBlock() {
			return getRuleContext(ScriptBlockContext.class,0);
		}
		public TerminalNode KW_WHILE() { return getToken(FunicParser.KW_WHILE, 0); }
		...
		@Override public int getRuleIndex() { return RULE_doWhileExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class WhileExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_whileExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class IfElseExpressContext extends ParserRuleContext {
		public List<TerminalNode> KW_IF() { return getTokens(FunicParser.KW_IF); }
		...
		public List<TerminalNode> KW_ELSE() { return getTokens(FunicParser.KW_ELSE); }
		public TerminalNode KW_ELSE(int i) {
			return getToken(FunicParser.KW_ELSE, i);
		}
		public List<TerminalNode> KW_ELIF() { return getTokens(FunicParser.KW_ELIF); }
		...
		@Override public int getRuleIndex() { return RULE_ifElseExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class CastAsRightPartContext extends ParserRuleContext {
		public TerminalNode KW_AS() { return getToken(FunicParser.KW_AS, 0); }
		...
		@Override public int getRuleIndex() { return RULE_castAsRightPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitCastAsRightPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MapValueExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_mapValueExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitMapValueExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class UnpackMapExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_unpackMapExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitUnpackMapExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class KeyValueExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_keyValueExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitKeyValueExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ThirdOperateRightPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_thirdOperateRightPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitThirdOperateRightPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class InstanceFieldValueRightPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_instanceFieldValueRightPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitInstanceFieldValueRightPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CircleExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_circleExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class NewArrayExpressContext extends ParserRuleContext {
		public TerminalNode KW_NEW() { return getToken(FunicParser.KW_NEW, 0); }
		public FullNameContext fullName() {
			return getRuleContext(FullNameContext.class,0);
		}
		...
		@Override public int getRuleIndex() { return RULE_newArrayExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitNewArrayExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NewInstanceExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_newInstanceExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitNewInstanceExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class InstanceFunctionCallRightPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_instanceFunctionCallRightPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitInstanceFunctionCallRightPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class GlobalFunctionCallContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitGlobalFunctionCall(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SquareQuoteRightPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_squareQuoteRightPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitSquareQuoteRightPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FactorPercentRightPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_factorPercentRightPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitFactorPercentRightPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IncrDecrAfterRightPartContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_incrDecrAfterRightPart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitIncrDecrAfterRightPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AssignRightPartContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitAssignRightPart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StaticFieldValueContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_staticFieldValue; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitStaticFieldValue(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StaticFunctionCallContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitStaticFunctionCall(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionArgumentsContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitFunctionArguments(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionArgumentContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitFunctionArgument(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final FunctionArgumentContext functionArgument() throws RecognitionException {
		...
		enterRule(_localctx, 114, RULE_functionArgument);
		try {
			setState(638);
			_errHandler.sync(this);
	...
	public static class ListValueExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_listValueExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitListValueExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ListValueExpressContext listValueExpress() throws RecognitionException {
		...
		enterRule(_localctx, 116, RULE_listValueExpress);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -252163031667015628L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 272679303068671L) != 0)) {
				{
				setState(641);
				unpackListExpress();
				setState(646);
	...
	public static class UnpackListExpressContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_unpackListExpress; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitUnpackListExpress(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final UnpackListExpressContext unpackListExpress() throws RecognitionException {
		...
		enterRule(_localctx, 118, RULE_unpackListExpress);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class FullNameContext extends ParserRuleContext {
		public List<TerminalNode> IDENTIFIER() { return getTokens(FunicParser.IDENTIFIER); }
	...
	public static class TypeClassContext extends ParserRuleContext {
		...
		public TerminalNode KW_CONST_CLASS() { return getToken(FunicParser.KW_CONST_CLASS, 0); }
	...
	public final TypeClassContext typeClass() throws RecognitionException {
		...
		enterRule(_localctx, 122, RULE_typeClass);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(669);
	...
	public final TypeMemberContext typeMember() throws RecognitionException {
		...
		enterRule(_localctx, 126, RULE_typeMember);
		try {
			setState(685);
			_errHandler.sync(this);
	...
	public static class ValueSegmentContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_valueSegment; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public final ValueSegmentContext valueSegment() throws RecognitionException {
		...
		enterRule(_localctx, 128, RULE_valueSegment);
		try {
			setState(691);
			_errHandler.sync(this);
	...
	public static class RefValueContext extends ParserRuleContext {
		public TerminalNode TERM_CONST_VISITOR() { return getToken(FunicParser.TERM_CONST_VISITOR, 0); }
	...
	public final RefValueContext refValue() throws RecognitionException {
		...
		enterRule(_localctx, 130, RULE_refValue);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(693);
	...
	public final VariableValueContext variableValue() throws RecognitionException {
		...
		enterRule(_localctx, 132, RULE_variableValue);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(695);
	...
	public final ConstValueContext constValue() throws RecognitionException {
		...
		enterRule(_localctx, 134, RULE_constValue);
		try {
			setState(702);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public static class ConstCharSequenceContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_constCharSequence; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitConstCharSequence(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ConstCharSequenceContext constCharSequence() throws RecognitionException {
		...
		enterRule(_localctx, 136, RULE_constCharSequence);
		try {
			setState(706);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public static class ConstStringContext extends ParserRuleContext {
		public TerminalNode TERM_CONST_STRING() { return getToken(FunicParser.TERM_CONST_STRING, 0); }
		public TerminalNode TERM_CONST_STRING_SINGLE() { return getToken(FunicParser.TERM_CONST_STRING_SINGLE, 0); }
	...
	public final ConstStringContext constString() throws RecognitionException {
		...
		enterRule(_localctx, 138, RULE_constString);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ConstRenderStringContext extends ParserRuleContext {
		public TerminalNode TERM_CONST_STRING_RENDER() { return getToken(FunicParser.TERM_CONST_STRING_RENDER, 0); }
		public TerminalNode TERM_CONST_STRING_RENDER_SINGLE() { return getToken(FunicParser.TERM_CONST_STRING_RENDER_SINGLE, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitConstRenderString(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ConstRenderStringContext constRenderString() throws RecognitionException {
		...
		enterRule(_localctx, 140, RULE_constRenderString);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ConstMultiStringContext extends ParserRuleContext {
		public TerminalNode TERM_CONST_STRING_MULTILINE() { return getToken(FunicParser.TERM_CONST_STRING_MULTILINE, 0); }
		public TerminalNode TERM_CONST_STRING_MULTILINE_QUOTE() { return getToken(FunicParser.TERM_CONST_STRING_MULTILINE_QUOTE, 0); }
		public ConstMultiStringContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_constMultiString; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FunicVisitor ) return ((FunicVisitor<? extends T>)visitor).visitConstMultiString(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ConstMultiStringContext constMultiString() throws RecognitionException {
		...
		enterRule(_localctx, 142, RULE_constMultiString);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ConstNumericContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_constNumeric; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public final ConstNumericContext constNumeric() throws RecognitionException {
		...
		enterRule(_localctx, 144, RULE_constNumeric);
		try {
			setState(716);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public static class ConstNumberContext extends ParserRuleContext {
		public TerminalNode TERM_CONST_NUMBER_HEX() { return getToken(FunicParser.TERM_CONST_NUMBER_HEX, 0); }
		public TerminalNode TERM_CONST_NUMBER_OTC() { return getToken(FunicParser.TERM_CONST_NUMBER_OTC, 0); }
		public TerminalNode TERM_CONST_NUMBER_BIN() { return getToken(FunicParser.TERM_CONST_NUMBER_BIN, 0); }
		public TerminalNode TERM_CONST_NUMBER() { return getToken(FunicParser.TERM_CONST_NUMBER, 0); }
	...
	public final ConstNumberContext constNumber() throws RecognitionException {
		...
		enterRule(_localctx, 146, RULE_constNumber);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ConstFloatContext extends ParserRuleContext {
		public TerminalNode TERM_CONST_NUMBER_SCIEN_2() { return getToken(FunicParser.TERM_CONST_NUMBER_SCIEN_2, 0); }
		public TerminalNode TERM_CONST_NUMBER_SCIEN_1() { return getToken(FunicParser.TERM_CONST_NUMBER_SCIEN_1, 0); }
		public TerminalNode TERM_CONST_NUMBER_FLOAT() { return getToken(FunicParser.TERM_CONST_NUMBER_FLOAT, 0); }
		public ConstFloatContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_constFloat; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public final ConstFloatContext constFloat() throws RecognitionException {
		...
		enterRule(_localctx, 148, RULE_constFloat);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ConstBooleanContext extends ParserRuleContext {
		public TerminalNode KW_CONST_BOOLEAN() { return getToken(FunicParser.KW_CONST_BOOLEAN, 0); }
		public ConstBooleanContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_constBoolean; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public final ConstBooleanContext constBoolean() throws RecognitionException {
		...
		enterRule(_localctx, 150, RULE_constBoolean);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(722);
	...
	public static class ConstNullContext extends ParserRuleContext {
		public TerminalNode KW_CONST_NULL() { return getToken(FunicParser.KW_CONST_NULL, 0); }
	...
	public final ConstNullContext constNull() throws RecognitionException {
		...
		enterRule(_localctx, 152, RULE_constNull);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(724);
	...
	public static final String _serializedATN =
		...
		">\u0001>\u0001?\u0001?\u0001?\u0001?\u0001?\u0001?\u0001?\u0001?\u0001"+
		"?\u0003?\u02ae\b?\u0001@\u0001@\u0001@\u0001@\u0003@\u02b4\b@\u0001A\u0001"+
		"A\u0001B\u0001B\u0001C\u0001C\u0001C\u0001C\u0001C\u0003C\u02bf\bC\u0001"+
		"D\u0001D\u0003D\u02c3\bD\u0001E\u0001E\u0001F\u0001F\u0001G\u0001G\u0001"+

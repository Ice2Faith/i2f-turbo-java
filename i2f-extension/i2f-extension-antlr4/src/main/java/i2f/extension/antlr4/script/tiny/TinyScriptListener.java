...
public interface TinyScriptListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TinyScriptParser#prefixOperator}.
	 * @param ctx the parse tree
	 */
	void enterPrefixOperator(TinyScriptParser.PrefixOperatorContext ctx);
	/**
	 * Exit a parse tree produced by {@link TinyScriptParser#prefixOperator}.
	 * @param ctx the parse tree
	 */
	void exitPrefixOperator(TinyScriptParser.PrefixOperatorContext ctx);
	/**
	 * Enter a parse tree produced by {@link TinyScriptParser#pipelineFunctionSegment}.
	 * @param ctx the parse tree
	 */
	void enterPipelineFunctionSegment(TinyScriptParser.PipelineFunctionSegmentContext ctx);
	/**
	 * Exit a parse tree produced by {@link TinyScriptParser#pipelineFunctionSegment}.
	 * @param ctx the parse tree
	 */
	void exitPipelineFunctionSegment(TinyScriptParser.PipelineFunctionSegmentContext ctx);
	/**
	 * Enter a parse tree produced by {@link TinyScriptParser#declareFunction}.
	 * @param ctx the parse tree
	 */
	void enterDeclareFunction(TinyScriptParser.DeclareFunctionContext ctx);
	/**
	 * Exit a parse tree produced by {@link TinyScriptParser#declareFunction}.
	 * @param ctx the parse tree
	 */
	void exitDeclareFunction(TinyScriptParser.DeclareFunctionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TinyScriptParser#doWhileSegment}.
	 * @param ctx the parse tree
	 */
	void enterDoWhileSegment(TinyScriptParser.DoWhileSegmentContext ctx);
	/**
	 * Exit a parse tree produced by {@link TinyScriptParser#doWhileSegment}.
	 * @param ctx the parse tree
	 */
	void exitDoWhileSegment(TinyScriptParser.DoWhileSegmentContext ctx);
	/**

...
public class TinyScriptParser extends Parser {
	...
	public static final int
		RULE_script = 0, RULE_segments = 1, RULE_express = 2, RULE_prefixOperator = 3, 
		RULE_pipelineFunctionSegment = 4, RULE_declareFunction = 5, RULE_parameterList = 6, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"script", "segments", "express", "prefixOperator", "pipelineFunctionSegment", 
			"declareFunction", "parameterList", "debuggerSegment", "trySegment", 
			"throwSegment", "tryBodyBlock", "catchBodyBlock", "finallyBodyBlock", 
			"classNameBlock", "parenSegment", "controlSegment", "whileSegment", "doWhileSegment", 
			"forSegment", "foreachSegment", "namingBlock", "ifSegment", "conditionBlock", 
			"scriptBlock", "equalValue", "extractExpress", "extractPairs", "extractPair", 
			"staticEnumValue", "newInstance", "invokeFunction", "functionCall", "refCall", 
	...
	public final ScriptContext script() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2303595113525279744L) != 0) || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 279450615807L) != 0)) {
				{
				setState(108);
				segments();
				}
	...
	public static class SegmentsContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TinyScriptVisitor ) return ((TinyScriptVisitor<? extends T>)visitor).visitSegments(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PrefixOperatorContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TinyScriptListener ) ((TinyScriptListener)listener).enterPrefixOperator(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TinyScriptListener ) ((TinyScriptListener)listener).exitPrefixOperator(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TinyScriptVisitor ) return ((TinyScriptVisitor<? extends T>)visitor).visitPrefixOperator(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final PrefixOperatorContext prefixOperator() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_prefixOperator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(191);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 12884902912L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class PipelineFunctionSegmentContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_pipelineFunctionSegment; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TinyScriptListener ) ((TinyScriptListener)listener).enterPipelineFunctionSegment(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TinyScriptListener ) ((TinyScriptListener)listener).exitPipelineFunctionSegment(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TinyScriptVisitor ) return ((TinyScriptVisitor<? extends T>)visitor).visitPipelineFunctionSegment(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final PipelineFunctionSegmentContext pipelineFunctionSegment() throws RecognitionException {
		...
		enterRule(_localctx, 8, RULE_pipelineFunctionSegment);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class DeclareFunctionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TinyScriptVisitor ) return ((TinyScriptVisitor<? extends T>)visitor).visitDeclareFunction(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final DeclareFunctionContext declareFunction() throws RecognitionException {
		...
		enterRule(_localctx, 10, RULE_declareFunction);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class DoWhileSegmentContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_doWhileSegment; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TinyScriptVisitor ) return ((TinyScriptVisitor<? extends T>)visitor).visitDoWhileSegment(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StaticEnumValueContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_staticEnumValue; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TinyScriptVisitor ) return ((TinyScriptVisitor<? extends T>)visitor).visitStaticEnumValue(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\'\u0001\'\u0001(\u0001(\u0001)\u0001)\u0001*\u0001*\u0001+\u0001+\u0001"+
		",\u0001,\u0001-\u0001-\u0001.\u0001.\u0001/\u0001/\u00010\u00010\u0001"+
		"0\u00010\u00010\u00030\u01da\b0\u00011\u00011\u00031\u01de\b1\u00011\u0001"+
		"1\u00012\u00012\u00012\u00052\u01e5\b2\n2\f2\u01e8\t2\u00013\u00013\u0003"+
		"3\u01ec\b3\u00013\u00013\u00013\u00014\u00014\u00034\u01f3\b4\u00014\u0001"+
		"4\u00015\u00015\u00015\u00055\u01fa\b5\n5\f5\u01fd\t5\u00015\u0000\u0001"+
		"\u00046\u0000\u0002\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018"+

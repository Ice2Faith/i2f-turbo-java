package i2f.extension.ai.langchain4j.rag;
...
@Data
@NoArgsConstructor
public class Langchain4jRagEmbeddingStore implements RagEmbeddingStore {
    protected EmbeddingStore<TextSegment> store;

    public Langchain4jRagEmbeddingStore(EmbeddingStore<TextSegment> store) {
        this.store = store;
    }

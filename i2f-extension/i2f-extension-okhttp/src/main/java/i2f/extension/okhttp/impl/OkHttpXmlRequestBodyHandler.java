 ...
 * @desc
 */
public class OkHttpXmlRequestBodyHandler implements IOkHttpHttpRequestBodyHandler {
    private IXmlSerializer xmlSerializer;

    public OkHttpXmlRequestBodyHandler(IXmlSerializer xmlSerializer) {
    ...
    public void writeBody(Object data, HttpRequest request, Request.Builder output, Object... args) throws IOException {
        ...
        String content = xmlSerializer.serialize(data);

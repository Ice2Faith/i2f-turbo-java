package i2f.velocity.directives.sql;
 ...
 * #end
 */
public class SqlSetDirective extends Directive {
    public static final String NAME = "sqlSet";
    ...
    public boolean render(InternalContextAdapter context, Writer writer, Node node) throws IOException, ResourceNotFoundException, ParseErrorException, MethodInvocationException {
        List<String> trimPrefixList = new ArrayList<>(Collections.singletonList(","));
        List<String> trimSuffixList = new ArrayList<>(Collections.singletonList(","));
        String appendPrefix = " set ";

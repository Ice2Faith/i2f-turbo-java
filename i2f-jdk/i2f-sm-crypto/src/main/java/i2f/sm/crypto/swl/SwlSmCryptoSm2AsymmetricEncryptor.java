...
import i2f.sm.crypto.std.SmCryptoSm2Encryptor;
 ...
 * @desc
 */
public class SwlSmCryptoSm2AsymmetricEncryptor implements ISwlAsymmetricEncryptor {
    private SmCryptoSm2Encryptor encryptor = new SmCryptoSm2Encryptor();

    @Override
    public AsymKeyPair generateKeyPair() {
        KeyPair keypair = SmCryptoSm2Encryptor.genKey();

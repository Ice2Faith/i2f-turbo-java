...
//    }
    ...
    public static String doEncrypt(String msgStr, String publicKeyHex, CipherMode cipherMode) {
        if (cipherMode == null) {
...
//    }
    ...
    public static String doDecrypt(String encryptData, String privateKeyHex, CipherMode cipherMode) {
        if (cipherMode == null) {
            cipherMode = CipherMode.C1C3C2;
        }

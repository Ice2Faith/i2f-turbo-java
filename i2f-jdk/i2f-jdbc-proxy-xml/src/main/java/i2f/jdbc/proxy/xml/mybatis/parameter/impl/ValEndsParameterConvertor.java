 ...
 * @desc
 */
public class ValEndsParameterConvertor implements ParameterConvertor {
    public static final ValEndsParameterConvertor INSTANCE=new ValEndsParameterConvertor();
    public static final String NAME="v-ends";
    @Override

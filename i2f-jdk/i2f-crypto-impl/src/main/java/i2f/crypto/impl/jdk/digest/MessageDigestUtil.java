...
public class MessageDigestUtil {
    ...
    public static String hmacMd2(byte[] key, byte[] data) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_MD2.apply(key, null).digest(data));
    }

    public static String hmacMd2(byte[] key, InputStream is) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_MD2.apply(key, null).digest(is));
    }

    public static String hmacMd5(byte[] key, byte[] data) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_MD5.apply(key, null).digest(data));
    }

    public static String hmacMd5(byte[] key, InputStream is) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_MD5.apply(key, null).digest(is));
    }

    public static String hmacSha1(byte[] key, byte[] data) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_SHA_1.apply(key, null).digest(data));
    }

    public static String hmacSha1(byte[] key, InputStream is) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_SHA_1.apply(key, null).digest(is));
    }

    public static String hmacSha224(byte[] key, byte[] data) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_SHA_224.apply(key, null).digest(data));
    }

    public static String hmacSha224(byte[] key, InputStream is) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_SHA_224.apply(key, null).digest(is));
    }

    public static String hmacSha256(byte[] key, byte[] data) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_SHA_256.apply(key, null).digest(data));
    }

    public static String hmacSha256(byte[] key, InputStream is) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_SHA_256.apply(key, null).digest(is));
    }

    public static String hmacSha384(byte[] key, byte[] data) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_SHA_384.apply(key, null).digest(data));
    }

    public static String hmacSha384(byte[] key, InputStream is) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_SHA_384.apply(key, null).digest(is));
    }

    public static String hmacSha512(byte[] key, byte[] data) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_SHA_512.apply(key, null).digest(data));
    }

    public static String hmacSha512(byte[] key, InputStream is) throws Exception {
        return HexStringByteCodec.INSTANCE.encode(HmacMessageDigester.HMAC_SHA_512.apply(key, null).digest(is));
    }

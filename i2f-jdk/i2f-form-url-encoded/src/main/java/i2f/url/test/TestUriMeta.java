...
public class TestUriMeta {
    public static void main(String[] args) {
        String[] urls = new String[]{
                ...
                "http://localhost:63342/i2f-turbo-java/i2f-extension-reverse-engineer-generator/tpl/doc/tables-struct.html?_ijt=xxx&_ij_reload=RELOAD_ON_SAVE",
                "https://www.bilibili.com/video/BVxxx/?spm_id_from=333.1007.tianma.1-1-1.click&vd_source=4628f88881f128426a727cedb9ddc861",

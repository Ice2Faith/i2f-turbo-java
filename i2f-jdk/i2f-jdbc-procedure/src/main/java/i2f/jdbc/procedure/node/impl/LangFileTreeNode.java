 ...
 */
public class LangFileTreeNode extends AbstractExecutorNode {
    public static final String TAG_NAME = TagConsts.LANG_FILE_TREE;
    ...
    public static void treeFile(File file, Collection<File> col){
        if(file==null){
            return;
        }
        col.add(file);

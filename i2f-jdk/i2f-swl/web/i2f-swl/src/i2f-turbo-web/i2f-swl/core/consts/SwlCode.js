const SwlCode = {
    ...
    CLIENT_ASYM_KEY_NOT_FOUND_EXCEPTION: () => (7100),


    SERVER_ASYM_KEY_EXCEPTION: () => (8000),
    SERVER_ASYM_KEY_NOT_FOUND_EXCEPTION: () => (8100),

    DIGITAL_EXCEPTION: () => (9000),
    DIGITAL_MISSING_EXCEPTION: () => (9100),
    DIGITAL_VERIFY_FAILURE_EXCEPTION: () => (9100),

    CERT_EXCEPTION:()=>(10000),
    CERT_ID_MISSING_EXCEPTION:()=>(10100),
}


export default SwlCode

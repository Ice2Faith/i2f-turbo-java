...
/**
 * @return SwlTransferBackup
 * @constructor
 */
function SwlTransferBackup() {
    /**
     *
...
SwlTransferBackup.SELF_KEY_PAIR_CURRENT_KEY = function () {
    return "swl:key:self:current"

};
SwlTransferBackup.SELF_KEY_PAIR_HISTORY_KEY_PREFIX = function () {
    return "swl:key:self:history:"
};
SwlTransferBackup.OTHER_KEY_PUBLIC_KEY_PREFIX = function () {
    return "swl:key:other:keys:"
};
SwlTransferBackup.OTHER_KEY_PUBLIC_DEFAULT = function () {
    return "swl:key:other:default"
};
SwlTransferBackup.NONCE_PREFIX = function () {
    return "swl:nonce:"
};
SwlTransferBackup.KEYPAIR_SEPARATOR = function () {
    return "\n==========\n"
};
 ...
 * @return {void}
 */
SwlTransferBackup.prototype.initialRefreshingThread = function () {
    if (this.refreshing) {
        return
    }
 ...
 * @return {String}
 */
SwlTransferBackup.prototype.cacheKey = function (key) {
 ...
 * @return {AsymKeyPair}
 */
SwlTransferBackup.prototype.getSelfKeyPair = function () {
    let obj = this.cache.get(this.cacheKey(SwlTransferBackup.SELF_KEY_PAIR_CURRENT_KEY()));
    if (obj == null) {
        return this.resetSelfKeyPair();
    }
    let key = SwlTransferBackup.SELF_KEY_PAIR_HISTORY_KEY_PREFIX() + obj;
    obj = this.cache.get(this.cacheKey(key));
    if (obj == null) {
        return this.resetSelfKeyPair();
    }

    let arr = obj.split(SwlTransferBackup.KEYPAIR_SEPARATOR(), 2);
 ...
 * @return {String}
 */
SwlTransferBackup.prototype.getSelfPublicKey = function () {
 ...
 * @return {String}
 */
SwlTransferBackup.prototype.calcKeySign = function (publicKey) {
 ...
 * @return {void}
 */
SwlTransferBackup.prototype.setSelfKeyPair = function (selfAsymSign, selfKeyPair) {
    let key = SwlTransferBackup.SELF_KEY_PAIR_HISTORY_KEY_PREFIX() + selfAsymSign;
    let keyPair = new AsymKeyPair(
        this.obfuscateEncode(selfKeyPair.getPublicKey()),
        this.obfuscateEncode(selfKeyPair.getPrivateKey())
    );
    let text = keyPair.getPublicKey() + SwlTransferBackup.KEYPAIR_SEPARATOR() + keyPair.getPrivateKey();
    this.cache.setWith(this.cacheKey(key), text, this.config.selfKeyMaxCount * this.config.selfKeyExpireSeconds);
    this.cache.set(this.cacheKey(SwlTransferBackup.SELF_KEY_PAIR_CURRENT_KEY()), selfAsymSign);
}
 ...
 * @return {String|null}
 */
SwlTransferBackup.prototype.getSelfPrivateKey = function (selfAsymSign) {
    let key = SwlTransferBackup.SELF_KEY_PAIR_HISTORY_KEY_PREFIX() + selfAsymSign;
 ...
 * @return {String|null}
 */
SwlTransferBackup.prototype.getOtherPublicKey = function (otherAsymSign) {
    let key = SwlTransferBackup.OTHER_KEY_PUBLIC_KEY_PREFIX() + otherAsymSign;
    let obj = this.cache.get(this.cacheKey(key));
    if (obj == null) {
        return null;
    }
 ...
 * @return {String|null}
 */
SwlTransferBackup.prototype.getOtherPublicKeyDefault = function () {
    let obj = this.cache.get(this.cacheKey(SwlTransferBackup.OTHER_KEY_PUBLIC_DEFAULT()));
    if (obj == null) {
        return null;
    }
 ...
 * @return {void}
 */
SwlTransferBackup.prototype.setOtherPublicKey = function (otherAsymSign, publicKey) {
    let key = SwlTransferBackup.OTHER_KEY_PUBLIC_KEY_PREFIX() + otherAsymSign;
    this.cache.setWith(this.cacheKey(key), this.obfuscateEncode(publicKey), this.config.otherKeyExpireSeconds);
    this.cache.set(this.cacheKey(SwlTransferBackup.OTHER_KEY_PUBLIC_DEFAULT()), otherAsymSign);
}
 ...
 * @return {void}
 */
SwlTransferBackup.prototype.refreshOtherPublicKeyExpire = function (otherAsymSign) {
    let key = SwlTransferBackup.OTHER_KEY_PUBLIC_KEY_PREFIX() + otherAsymSign;
 ...
 * @return {boolean}
 */
SwlTransferBackup.prototype.containsNonce = function (nonce) {
    let key = SwlTransferBackup.NONCE_PREFIX() + nonce;
 ...
 * @return {void}
 */
SwlTransferBackup.prototype.setNonce = function (nonce, timeoutSeconds) {
    let key = SwlTransferBackup.NONCE_PREFIX() + nonce;
 ...
 * @return {void}
 */
SwlTransferBackup.prototype.acceptOtherPublicKey = function (otherPublicKey) {
 ...
 * @return {String}
 */
SwlTransferBackup.prototype.getSelfSwapKey = function () {
 ...
 * @return {void}
 */
SwlTransferBackup.prototype.acceptOtherSwapKey = function (otherSwapKey) {
 ...
 * @return {AsymKeyPair}
 */
SwlTransferBackup.prototype.resetSelfKeyPair = function () {
 ...
 * @return {String|null}
 */
SwlTransferBackup.prototype.obfuscateEncode = function (data) {
    if (!data) {
        return null;
    }
    if (!this.obfuscator) {
 ...
 * @return {String|null}
 */
SwlTransferBackup.prototype.obfuscateDecode = function (data) {
    if (!data) {
        return null;
    }
    if (!this.obfuscator) {
 ...
 * @return {SwlData}
 */
SwlTransferBackup.prototype.send = function (remotePublicKey, parts, attaches = null) {
    let ret = new SwlData();
    ret.parts = [];
    ret.attaches = []
 ...
 * @return {SwlData}
 */
SwlTransferBackup.prototype.receive = function (clientId, request) {
    let ret = new SwlData();
    ret.parts = ([]);
    ret.attaches = ([]);
    ...
    let window = this.config.timestampExpireWindowSeconds;
 ...
 * @return {SwlData}
 */
SwlTransferBackup.prototype.sendDefault = function (parts, attaches = null) {
 ...
 * @return {SwlData}
 */
SwlTransferBackup.prototype.response = function (remoteAsymSign, parts, attaches = null) {
    let otherPublicKey = this.getOtherPublicKey(remoteAsymSign);
    return this.send(otherPublicKey, parts, attaches);
}

export default SwlTransferBackup

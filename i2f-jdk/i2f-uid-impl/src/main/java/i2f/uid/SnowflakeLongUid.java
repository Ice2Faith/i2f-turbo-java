 ...
 */
public class SnowflakeLongUid implements ILongUid {
    public static final SnowflakeLongUid INSTANCE = getByMac();
     ...
     * 全局的实例
     */
    public static SnowflakeLongUid UID = INSTANCE;
     ...
     * @return
     */
    public static SnowflakeLongUid getByMac() {
        long workerId = 0;
        try {
        ...
        return new SnowflakeLongUid(workerId);
    }

    public SnowflakeLongUid(long workerId) {
        this(workerId, null);
    }

    public SnowflakeLongUid(long workerId, IClock clock) {

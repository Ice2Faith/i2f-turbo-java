package i2f.template.render;


import i2f.reflect.ReflectResolver;
import i2f.template.render.core.ObjectFinder;
import i2f.template.render.core.impl.*;
import i2f.template.render.data.JsonControlMeta;
import i2f.template.render.impl.DefaultValueMapper;
import i2f.template.render.impl.FileTemplateLoader;
...
public class RegexGenerator {
    ...
    public static String render(String template, Map<String, Object> param, List<String> basePackages) {
        Function<Object, String> mapper = new DefaultValueMapper();
     ...
     * @return
     */
    public static String render(String template, Map<String, Object> param, Function<Object, String> mapper, List<String> basePackages) {
    ...
    private static String loadTemplate(String loaderClass, String loadKey) {
        Function<String, String> loader = null;
        if (loaderClass != null && !"".equals(loaderClass)) {
            Class<?> clazz = ReflectResolver.loadClass(loaderClass);
            if (clazz != null) {
                try {
                    loader = (Function<String, String>) ReflectResolver.getInstance(clazz);
     ...
     * @return 模板渲染结果
     */
    public static String generate(String template, Object param, Function<Object, String> mapper, List<String> basePackages) {

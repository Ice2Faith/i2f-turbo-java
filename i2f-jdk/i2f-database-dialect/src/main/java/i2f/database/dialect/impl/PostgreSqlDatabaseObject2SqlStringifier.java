 ...
 */
public class PostgreSqlDatabaseObject2SqlStringifier extends AbsDatabaseObject2SqlStringifier {
    public static final PostgreSqlDatabaseObject2SqlStringifier INSTANCE = new PostgreSqlDatabaseObject2SqlStringifier();
    ...
    public static String toDate(String date, String oraPattern) {
        return "TO_TIMESTAMP(" + DatabaseDialectUtil.decorateAsSqlString(date) + "," + DatabaseDialectUtil.decorateAsSqlString(oraPattern) + ")";
    }
}

...
<img src="./imgs/11-ai_stack.svg" alt="AI 能力栈分层全景" width="100%" />
...
<img src="./imgs/12-serialize_codec_family.svg" alt="序列化编解码契约族谱" width="100%" />
...
<img src="./imgs/13-crypto_security.svg" alt="加密与安全能力全景" width="100%" />
...
<img src="./imgs/14-data_jdbc_pipeline.svg" alt="数据-JDBC 管线全景" width="100%" />
...
<img src="./imgs/15-xproc4j_orchestration.svg" alt="XProc4J 存储过程编排全景" width="100%" />
...
<img src="./imgs/16-script_funic_engine.svg" alt="脚本引擎 ANTLR4-Funic-TinyScript 全景" width="100%" />

### 17 统一文件系统抽象

一份 `IFileSystem` / `IFile` 契约收敛 7 种存储后端：本地 `JdkFileSystem` 与 FTP / SFTP（含代理）/ HDFS / MinIO / 阿里云 OSS / AWS S3，接口→抽象类→实现分层，内建路径遍历防护与跨系统透明搬运。

<img src="./imgs/17-filesystem_abstraction.svg" alt="统一文件系统抽象全景" width="100%" />
...
<img src="./imgs/18-graphics_imaging.svg" alt="图形学与图像处理全景" width="100%" />
...
<img src="./imgs/19-native_jni.svg" alt="JNI 原生调用体系全景" width="100%" />

...
public class DashScopeOpsD3TripoController {
    ...
    public String d3Tripo(DashScopeD3TripoOperateDto req) throws Exception {
        ...
        ResponseEntity<String> respEntity = controller.getRestTemplate().exchange("https://dashscope.aliyuncs.com/api/v1/services/aigc/video-generation/3d-generation",
                HttpMethod.POST,
                reqEntity,
                String.class);
    ...
    public OpsSecureReturn<OpsSecureDto> videoInsteadPeople(@RequestBody OpsSecureDto reqDto,
        ...
        try {
            DashScopeD3TripoOperateDto req = transfer.recv(reqDto, DashScopeD3TripoOperateDto.class);

            String taskId = d3Tripo(req);

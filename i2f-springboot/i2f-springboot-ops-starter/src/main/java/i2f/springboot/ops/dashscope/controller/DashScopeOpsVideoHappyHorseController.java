...
@NoArgsConstructor
@Controller
@RequestMapping(OpsConsts.SPEL_BASE_URL+"/dashscope/video/happyhorse")
public class DashScopeOpsVideoHappyHorseController {
    @Autowired
    ...
    public String videoHappyHorse(DashScopeVideoHappyHorseOperateDto req) throws Exception {
    ...
    public OpsSecureReturn<OpsSecureDto> videoInsteadPeople(@RequestBody OpsSecureDto reqDto,
        ...
        try {
            DashScopeVideoHappyHorseOperateDto req = transfer.recv(reqDto, DashScopeVideoHappyHorseOperateDto.class);

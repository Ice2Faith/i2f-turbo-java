...
public class Sm2Utils {
    ...
    public static String sign(String content, String privateKey) {
        ...
        try {
            sm2Signer.init(true, new ParametersWithID(new ParametersWithRandom(privateKeyParameters, SecureRandom.getInstance("SHA1PRNG")), Strings.toByteArray(SM2_PID)));
    ...
    public static boolean verify(String content, String publicKey, String sign) {
        ...
        //创建签名实例
        SM2Signer sm2Signer = new SM2Signer();
        ParametersWithID parametersWithID = new ParametersWithID(publicKeyParameters, Strings.toByteArray(SM2_PID));

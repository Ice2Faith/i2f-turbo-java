package i2f.springboot.xproc4j.proxy;

import i2f.springboot.xproc4j.SpringJdbcProcedureProperties;
import i2f.springboot.xproc4j.proxy.annotations.ProcedureMapper;
import lombok.Data;
...
@Slf4j
@Data
public class SpringJdbcProcedureProxyMapperAutoConfiguration implements ApplicationContextAware, EnvironmentAware, BeanDefinitionRegistryPostProcessor {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry beanDefinitionRegistry) throws BeansException {
        try {
            ...
            // 这个时期，bean还未实例化，在这里不能直接注入配置，否则会干扰配置
            SpringJdbcProcedureProperties jdbcProcedureProperties = Binder.get(environment)
                    .bind(SpringJdbcProcedureProperties.CONFIG_PREFIX, SpringJdbcProcedureProperties.class)
                    .orElse(new SpringJdbcProcedureProperties());
